 ...
 * @author viktor
 */
public interface HierarchicalAuditableEntityService<T extends IHierarchical<ID,T> & Auditable<?, ID>, ID extends Serializable> extends AuditableEntityService<T, ID> {
